...
# Questions for testing the retrieval system (Cat Dataset - Translated to English)
SAMPLE_QUERIES = [
    "What are the essential vaccines for cats?",
    "What foods or items are toxic to cats?",
...
def main():
    ...
    # Uses your internal Retriever class
    retriever = Retriever(
    ...
    for query in SAMPLE_QUERIES:
        ...
        for rank, item in enumerate(results, start=1):
            print(f"  [{rank}] ({item.get('score', 0.0):.4f}) {item.get('question', 'N/A')}")
