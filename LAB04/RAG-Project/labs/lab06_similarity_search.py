...
def main():
    ...
    # Updated query translated to English
    query = "What causes cats to pee outside the litter box?"
    ...
    for rank, (score, idx) in enumerate(zip(scores, indices), start=1):
        ...
        print(f"    Question: {chunk.get('question', 'N/A')}")
        print(f"    Answer: {chunk.get('answer', 'N/A')[:150]}...")
